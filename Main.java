...
public class Main {
    public static void main(String[] args) {
        ...
        accList.add(new Account(17, "Sawa Lucas", "Credit", "20000","0.6"));
        accList.add(new Account(18, "Bigira Darcy", "Debit", "20000","0.9"));
        accList.add(new Account(19, "Thibaut", "Saving", "20000","0.5"));
        accList.add(new Account(20, "Thibaut", "Checking", "20000","0.7"));
